...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<div class="card card-outline card-primary">
			...
			<div class="card-body">
				<p class="login-box-msg">ECUE</p>

				<form action="<?=base_url();?>/ecue/add" method="post">
					<div class="input-group mb-3">
						<input type="text" class="form-control" name="nom_ecue"
					...
					<div class="input-group mb-3">
						...
						<select class="form-control" aria-label="Default select example" name=id_mention>
							<option selected>UE</option>
							<?php foreach($ue as $u): ?>
							<option value="<?=$u['id_ue'];?>"><?=$u['nom_ue'];?></option>
							<?php endforeach;?>
						</select>
						<div class="input-group-append">
							<div class="input-group-text">
					...
					<div class="input-group mb-3">
						<input type="text" class="form-control" name="id_enseignant"
